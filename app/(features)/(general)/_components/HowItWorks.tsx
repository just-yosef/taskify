...
const HowItWorks = () => {
  return (
    <section className="mt-10">
      <TitleSection text="How It Works" translationKey="howItWorks" />
            ...
            >
              <CardHeader>
                <CardTitle>
                  <span
                    className={
                      ["text-teal", "text-sky", "text-rose", "text-peach"][i]
                    }
                  >
                    {icon}
                  </span>
              ...
              <CardContent className="text-muted-foreground -mt-5 text-sm">
                {" "}
                {desc}{" "}
              </CardContent>
            </Card>
